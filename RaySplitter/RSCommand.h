...
typedef enum {
  ...
  FC_DRAW_TRIANGLE_FAN,
  FC_DRAW_TRIANGLE_STRIP,
  FC_DRAW_POLY,
  FC_DRAW_POLY_LINES,
  FC_DRAW_POLY_LINES_EX,
  FC_DRAW_SPLINE_LINEAR,
  FC_DRAW_SPLINE_BASIS,
  FC_DRAW_SPLINE_CATMULL_ROM,
  FC_DRAW_SPLINE_BEZIER_QUADRATIC,
  FC_DRAW_SPLINE_BEZIER_CUBIC,
